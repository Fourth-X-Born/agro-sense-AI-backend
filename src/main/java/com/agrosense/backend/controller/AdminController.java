...
public class AdminController {
    ...
    public ResponseEntity<ContactMessage> updateContactMessage(
        ...
        return ResponseEntity.ok(adminService.updateContactMessage(id, request));
    }
